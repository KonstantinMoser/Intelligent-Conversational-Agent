...
* AnswerLabel: text of the answer provided by the worker. The possible values for this attribute are â€œCORRECTâ€ and â€œINCORRECTâ€.        
* FixPosition: when the answer provided by the worker is â€œINCORRECTâ€, the worker has the opportunity to include details on the way the triple should be fixed. FixPosition indicates the position of the RDF triple (subject, predicate, object) that the worker thinks needs to be corrected.
